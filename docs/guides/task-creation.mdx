...
"Access the expense management system, review all pending expense reports over $1,000, create a summary with policy violations flagged, and prepare for approval."
