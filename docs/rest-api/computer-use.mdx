...
<ParamField body="action" type="string" required>
  The type of computer action to perform. Must be one of: `move_mouse`, `click_mouse`, `drag_mouse`, `scroll`, `press_key`, `type_text`, `wait`, `screenshot`, `get_cursor_position`.
</ParamField>
