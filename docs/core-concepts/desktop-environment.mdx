...
The desktop environment in Bytebot is based on Openbox, a lightweight and efficient desktop environment for Unix-like operating systems:
...
2. Adjusting the Openbox configuration files for different layouts
